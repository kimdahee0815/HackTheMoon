---
dg-publish: true
dg-permalink: 2_Routine/4_Yearly/Overview/workout
tags:
  - yearly
  - workout
  - overview
...
const calendarData = {
    ...
    colors: {    // (optional) defaults to green
        ...
        yellow: ["#495057",  "#fff099", "#ffe880", "#ffd94d", "#ffca1a"], 
         violetGradation: ["#ce93d8",  "#e1bee7", "#ce93d8", "#ba68c8", "#ab47bc"], 
    ...
    intensityScaleEnd: 60 * 60 * 1000,     // (optional) defaults to highest value passed to entries.intensity
    entries: [],                // (required) populated in the DataviewJS loop below
}

//DataviewJS loop
for (let page of dv.pages('"2_Routine/1_Daily/Daily-Routine"').where(p => p.workout)) {
