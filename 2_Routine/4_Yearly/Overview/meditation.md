---
dg-publish: true
dg-permalink: 2_Routine/4_Yearly/Overview/meditation
tags:
  - yearly
  - meditation
  - overview
...
//DataviewJS loop
for (let page of dv.pages('"2_Routine/1_Daily/Daily-Routine"').where(p => p.meditation)) {
    ...
    calendarData.entries.push({
        ...
        content: await dv.span(`[.](2_Routine/1_Daily/Meditation/${page.file.name})`),           // (optional) Add text to the date cell
